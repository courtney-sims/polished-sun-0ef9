...
```
npm create cloudflare@latest -- --template=cloudflare/templates/polished-sun-0ef9
```

A live public deployment of this template is available at [https://polished-sun-0ef9.templates.workers.dev](https://polished-sun-0ef9.templates.workers.dev)
